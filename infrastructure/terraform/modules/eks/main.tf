...
resource "aws_iam_role" "cluster" {
  name = "kubechamp-${var.environment}-eks-cluster-role"
...
resource "aws_security_group" "cluster" {
  name        = "kubechamp-${var.environment}-eks-cluster-sg"
...
resource "aws_iam_openid_connect_provider" "cluster" {
  ...
  tags = {
    Name = "kubechamp-${var.environment}-oidc-provider"
  }
}

# Node Group IAM Role
resource "aws_iam_role" "node_group" {
  name = "kubechamp-${var.environment}-eks-node-group-role"
...
resource "aws_iam_role" "cluster_autoscaler" {
  ...
  name  = "kubechamp-${var.environment}-cluster-autoscaler-role"
...
resource "aws_iam_role" "ebs_csi" {
  ...
  name  = "kubechamp-${var.environment}-ebs-csi-driver-role"
...
resource "aws_iam_role" "cloudwatch_observability" {
  name = "kubechamp-${var.environment}-cloudwatch-observability-role"
